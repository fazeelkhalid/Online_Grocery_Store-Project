...
namespace freshCart
{
    public partial class restructCustomer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["Phone_number"] = "03352316132";
        ...
        public static void blockUnblockCust(string s1)
        {
            Remove_DAL tempobj = new Remove_DAL();
            Remove_DAL tempCart = new Remove_DAL();
            tempobj.restrictCustomer_DALfun(Int32.Parse(s1));
        }
